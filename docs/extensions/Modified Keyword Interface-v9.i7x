Version 9.0.1 of Modified Keyword Interface by Aaron Reed begins here.

"This extension is modified in order ot work with the Exit Lister by Gavin Lambert extension.
The only modified part is the Exit List section, being removed due to conflicting names.
...
Modified Keyword Interface ends here.
